...
(function() {
    ...
    function widget ($mdTheming) {
        ...
        function link($scope, $element, attrs) {
            ...
            console.log($element, $scope.vm.contentLayoutAlign);
...
(function() {
    ...
    DefaultToolbarController.$inject = ["$scope", "$rootScope", "$mdMedia", "$translate", "$state", "$element", "$filter", "$mdUtil", "$mdSidenav", "$mdToast", "$timeout", "triBreadcrumbsService", "triSettings", "triLayout"];
})();
(function() {
    'use strict';
...
(function() {
    ...
    function routeConfig($stateProvider) {
        ...
        .state('triangular', {
            abstract: true,
            templateUrl: 'app/triangular/layouts/default.tmpl.html',
